...
urlpatterns += patterns('everest.views.delete',
    ...
    url(r'^delete-englishaudio/(?P<englishaudio>[0-9]+)$','del_englishaudio',name='del_englishaudio'),
    url(r'^delete-nepaliaudio/(?P<nepaliaudio>[0-9]+)$','del_nepaliaudio',name='del_nepaliaudio'),
